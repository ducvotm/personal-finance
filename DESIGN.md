...
This repository now ships backend only. Keep this design document as brand and UI guidance for future clients (web/mobile) and implement visual decisions in the consuming client repository rather than in this service.